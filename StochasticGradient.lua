local StochasticGradient2 = torch.class('nn.StochasticGradient2')

function StochasticGradient2:__init(module, criterion)
...
function StochasticGradient2:train(dataset)
   local iteration = 1
   ...
   print("# StochasticGradient2: training")
   ...
   while true do
      ...
      if self.maxIteration > 0 and iteration > self.maxIteration then
         print("# StochasticGradient2: you have reached the maximum number of iterations")
